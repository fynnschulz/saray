  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-black via-[#18181b] to-[#23272f] relative overflow-x-hidden font-sans">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center relative z-10 px-4">
        <section className="pt-36 pb-24">
          ...
          <div className="mt-8 animate-fadein delay-600">
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 text-2xl sm:text-3xl md:text-4xl font-semibold text-white/90 hover:text-[#ff4d4d] transition-all duration-300 group"
            >
        ...
        <section className="w-full max-w-7xl mx-auto px-6 pb-20">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white text-center mb-4 animate-fadein">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Review 1 - Aylin */}
            <div className="bg-white/5 border-white/10 backdrop-blur-sm rounded-2xl p-6 border transition-all duration-300 hover:scale-105 hover:shadow-xl">
              ...
              <p className="text-white/90 mb-4 italic transition-colors duration-200">
              ...
              <p className="text-white/60 text-sm font-semibold transition-colors duration-200">
                — Aylin K.
              </p>
            </div>
