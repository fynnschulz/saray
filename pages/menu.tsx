    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-black via-[#18181b] to-[#23272f] relative overflow-x-hidden font-sans">
      ...
      <main className="flex-1 flex flex-col items-center justify-center relative z-10 px-4 pt-32 pb-16">
        <div className="w-full max-w-6xl">
          ...
          {/* Desktop View: Iframe */}
          <div className="hidden md:block bg-white/5 backdrop-blur-sm rounded-lg p-4 shadow-2xl border border-white/10">
            <iframe
              src="/speisekarte.pdf"
          ...
          <div className="md:hidden flex flex-col items-center justify-center gap-6 py-12">
            <div className="text-center mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-24 h-24 mx-auto text-[#ff4d4d] mb-4">
                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
              </svg>
              <p className="text-white/80 text-lg mb-2">Speisekarte ansehen</p>
              <p className="text-white/60 text-sm">Öffnet in Ihrem PDF-Viewer</p>
            </div>
            <a
              href="/speisekarte.pdf"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block px-8 py-4 rounded-full text-black font-bold text-lg shadow-lg hover:scale-105 hover:shadow-2xl transition-all duration-200 btn-glow-red btn-gradient-animate"
            >
              📄 Speisekarte öffnen
            </a>
          </div>
